...
// FeaturedProduct.tsx এর মতোই interface
export interface MostVisitedProductProps {
...
const MostVisitedProduct: React.FC<MostVisitedProductProps> = ({
  id, 
  productName,
  originalPrice,
  discountedPrice,
