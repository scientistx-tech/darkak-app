...
//       // totalProducts ক্যালকুলেশন - API থেকে না থাকলে estimate করুন
...
//         // API থেকে totalProducts না থাকলে estimate করুন
...
//       console.log(`📊 CALCULATED: Total products: ${totalProducts}, Has more: ${hasMore}`);
...
//         totalProducts: totalProducts, // ✅ আপডেট করা হয়েছে
//         hasMore: hasMore,
//       };
...
// redux/reducers/mostVisitedProduct.reducer.ts
import actionTypes from "../constants/actionTypes";
import { IMostVisitedProduct, IMostVisitedProductApiResponse } from "../types/MostVisitedProduct";
