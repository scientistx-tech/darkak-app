// types/TodaysDealProduct.ts

export interface ITodaysDealRequest {
  page?: number;
  limit?: number;
  search?: string;
  categoryId?: number;
...
export interface ITodaysDealProductImage {
  id: number;
  url: string;
  alt: string | null;
  productId: number;
...
export interface ITodaysDealItemOption {
  id: number;
  image: string;
  title: string;
  price: number;
...
export interface ITodaysDealItem {
  id: number;
  title: string;
  options: ITodaysDealItemOption[];
}

export interface ITodaysDealUser {
  id: number;
  name: string;
  email: string;
  phone: string;
...
export interface ITodaysDealProductDeliveryInfo {
  id: number;
...
export interface ITodaysDealProduct {
  id: number;
  title: string;
  slug: string;
  code: string;
  ...
  faq: any;
  content: string | null;
  Image: ITodaysDealProductImage[];
  review: any[];
  items: ITodaysDealItem[];
  user: ITodaysDealUser;
  delivery_info: ITodaysDealProductDeliveryInfo;
  avgRate: number;
  totalReview: number;
}

export interface ITodaysDealProductApiResponse {
  totalPage: number;
  data: ITodaysDealProduct[];
  statusCode?: number;
  error?: any;
  total?: number;
